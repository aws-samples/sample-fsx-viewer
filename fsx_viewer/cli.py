...
def parse_args(args: Optional[list] = None) -> Config:
    ...
    return Config(
        ...
        refresh_interval=int(get_value(parsed.refresh_interval, None, "refresh_interval", 300)),
        metric_interval=int(get_value(parsed.metric_interval, None, "metric_interval", 60)),
        disable_pricing=parsed.disable_pricing if parsed.disable_pricing else file_config.get("disable_pricing", "false").lower() == "true",
